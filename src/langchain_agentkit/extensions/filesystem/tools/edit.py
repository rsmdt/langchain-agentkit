...
- Use `replace_all` for replacing and renaming strings across the file. This parameter is useful when the same term appears in multiple places and all instances should change together."""
