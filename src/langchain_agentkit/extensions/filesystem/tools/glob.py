...
_GLOB_DESCRIPTION = """
Find files by name or path pattern. Use when you know a filename or shape but not where it lives. Returns matching paths only; it does not read file contents or search inside them.
"""
