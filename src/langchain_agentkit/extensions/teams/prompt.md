...
2. **SendMessage**: Send work, guidance, or follow-up instructions to members
3. **React to messages**: Members send results back automatically — process them as they arrive
4. **CheckTeammates**: See current status of all members and pending messages
5. **DissolveTeam**: Shut down the team when all work is complete
...
- **Unblock teammates**: If a teammate is waiting or stuck, provide guidance via SendMessage.
